...
public class IntRates {

	String end_of_month;
	String preliminary;
	double prime_lending_rate;
	double banks_fixed_deposits_3m;
	double banks_fixed_deposits_6m;
	double banks_fixed_deposits_12m;
	double banks_savings_deposits;
	double fc_hire_purchase_motor_3y;
	double fc_housing_loans_15y;
	double fc_fixed_deposits_3m;
	double fc_fixed_deposits_6m;
	double fc_fixed_deposits_12m;
	double fc_savings_deposits;
